...
# 调用函数
make_transparent("output/image/illus_image_deepseekV3.png", "output/transparent_image/illus_deepseekV3.png")
make_transparent("output/image/text_image_deepseekV3.png", "output/transparent_image/text_deepseekV3.png")
