...
# 调用函数
make_transparent("output/image/illus_image_Qwen_image_test.png", "output/transparent_image/Qwen_illus_test.png")
make_transparent("output/image/text_image_Qwen_test.png", "output/transparent_image/Qwen_text_test.png")
