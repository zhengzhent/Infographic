...
;(function () {
  ...
  const ILLUSTRATION_URL =
    '../transparent_image/illus_GPTimage_trimed_trans.png' // illustration
  ...
  async function runLayout(
    ...
    const maskObj = makeMaskObj(rawMask.mask, rawMask.width, rawMask.height)
  ...
  function fillMaskRect(maskObj, rect) {
    ...
    for (let y = yi; y < yi + hi && y < height; y++) {
